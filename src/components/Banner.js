...
const Banner = () => {
  return (
    <div className="bg-cover bg-center py-16 px-20 w-5/6 m-auto px-8 rounded-lg backdrop-blur-10 text-white" style={{ backgroundImage: 'url(https://media.istockphoto.com/id/1397366335/photo/graphics-cards-in-rig-for-ethereum-mining-farm-on-background-stock-market-eth-chart.jpg?s=612x612&w=0&k=20&c=I_ZXaqWJ8k7NFvJxCDwcwkAK976o34X9p0ZzrhwOTEA=)' }}>
