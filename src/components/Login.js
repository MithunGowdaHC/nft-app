  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-nft relative overflow-hidden">
      ...
      <div className="bg-black bg-opacity-70 p-8 rounded-xl shadow-2xl w-96 backdrop-blur-sm z-10">
        ...
        <h1 className='p-5 pl-0 text-3xl  text-purple-500 hover:text-purple-400 font-semibold transition duration-300" '>{signIn? "Sign In":"Sign Up"}</h1>
        ...
        <div className="mt-6 text-center">
          <a href="#" className="text-sm text-purple-400 hover:text-purple-300 transition duration-300">Forgot Password?</a>
        </div>
        ...
        <div className="mt-8 text-center">
          <p  className="text-gray-400">{signIn?"New to NFTribe?":"Already a member?"}</p>
          <a onClick={toggleSignIn} href="#" className="text-purple-500 hover:text-purple-400 font-semibold transition duration-300">
            {signIn?"Create an account":"Sign In now"}</a>
        </div>
      </div>
    </div>
  );
